...
const OFFERS: Offer[] = [
  ...
  {
    productType: "yearly-analysis",
    title: "Годишен Прогноз",
    hook: "Какво те очаква през следващите 12 месеца — астро прогноза",
    description:
      "Детайлен анализ на годината пред теб — кариера, любов, финанси, здраве. Кои месеци са ключови и как да ги използваш максимално.",
    oldPrice: 49.99,
    newPrice: 19.99,
    pages: "30+ страници PDF",
    whatYouGet: [
      "Месечен преглед на годината",
      "Ключови периоди за действие",
      "Любов и взаимоотношения прогноза",
      "Кариера и финанси прогноза",
      "Препоръки за всеки сезон",
    ],
    whoFor: "За тези, които искат да планират и да бъдат подготвени за промените пред тях.",
    buttonLabel: "Добави за €19.99",
  },
];
